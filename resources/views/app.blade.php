...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Na Mundo Le Pet, oferecemos atendimento veterinário especializado em Nutrologia e Dermatologia, além de consultas clínicas, exames e vacinação em Goiânia.">
        <meta name="robots" content="index, follow">

        <!-- Favicons Estáticos (Seguro) -->
        ...
        <!-- Scripts do Inertia e Vite Seguros -->
        @routes
        @viteReactRefresh
